...
```
docker compose run frontend yarn workspace @services/frontend yarn
docker compose run backend yarn workspace @services/backend yarn
docker compose run prisma yarn workspace @packages/prisma yarn
```
